...
/**
  ...
  */
trait ResultantMonadPackage {  //  The omnitool package object extends this trait.
  implicit class ResultantMonad[M[_]](RM: RelMonad[Result, M])
  extends Plus[M] with Monad[M] with MonadError[({type F[_, A] = M[A]})#F, These[String, Throwable]] {
